...
module.exports.playerStands = () =>
  `You stand with a hand of ${playerHand} and a total of ${playersTotal}`
...
let playerSplitHand1 = [playerHand[0], produceRandomCard()];
let playerSplitHand2 = [playerHand[1], produceRandomCard()];
...
module.export.cardsViewableByPlayer = () =>
  faceUpCards;
